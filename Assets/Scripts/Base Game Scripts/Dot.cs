...
public class Dot : MonoBehaviour
{
    ...
    //This is for testing and debuf only
    ...
    public IEnumerator CheckMoveCo()
    {
        ...
        {
            //The other piece is color bomb, and this piece has the color to destroy
            findMatches.MatchesPiecesOfColor(this.gameObject.tag);
            otherDot.GetComponent<Dot>().isMatched = true;
        }
        yield return new WaitForSeconds(movesDelay);
        ...
        if (otherDot != null)
        {
            ...
            else
            {
                ...
                {
                    if(endGameManager.requirement.gameType == GameType.Moves)
                    {
